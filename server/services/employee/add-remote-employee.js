...
const addRemoteEmployee = async (req, res) => {
  const { employeeName, employeeEmail, employeeContactNumber, employeeRole } =
    req.body;
  ...
  return responseHandler(
    ...
    201,
    'success',
    'remote employee created successfully',
    {
      employee: {
        employeeId: newEmployee.employeeId,
