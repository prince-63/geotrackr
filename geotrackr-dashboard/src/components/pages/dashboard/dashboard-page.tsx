...
const DashboardPage: React.FC = () => {
        ...
        datasets: [
            {
                label: 'Attendance',
                data: [
                    23, 45, 56, 78, 55, 72, 57, 21, 34, 72, 59, 72, 61, 8, 93,
                    39, 56, 78, 55, 72, 57, 21, 34, 72, 59, 72, 61, 8, 93, 39,
                ],
                fill: false,
    ...
    const announcements = [
        ...
        {
            message:
                'Annual performance reviews to be completed by 2024-09-30.',
        },
    ];
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 mb-8">
                ...
                <ul className="list-disc pl-8 text-gray-700 space-y-2">
                    {projectDeadlines.map((deadline, index) => (
                        <li key={index}>
                            <span className="font-bold">{deadline.name}</span> -
                            Due by {deadline.due}
                        </li>
                    ))}
                </ul>
