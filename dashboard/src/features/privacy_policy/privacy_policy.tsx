      ...
      <section className="bg-white dark:bg-slate-900 text-gray-900 py-16 px-6 sm:px-12 lg:px-24">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-lg sm:text-xl leading-relaxed text-gray-700 mb-12 text-center">
            At <span className="font-semibold text-indigo-600">Geotrackr</span>,
          ...
          <div className="group mb-10 p-6 bg-gray-100 rounded-lg shadow-sm transition-transform transform hover:-translate-y-2 hover:shadow-lg duration-300 ease-in-out border-l-4 border-indigo-600">
            ...
            <p className="text-base leading-relaxed text-gray-600">
              We collect personal information such as your location data to
              track attendance, along with your name, email address, and work
              details to facilitate the app’s functions. Location data is only
              collected when you check in or check out of your workplace.
            </p>
          </div>
          ...
          <div className="group mb-10 p-6 bg-gray-100 rounded-lg shadow-sm transition-transform transform hover:-translate-y-2 hover:shadow-lg duration-300 ease-in-out border-l-4 border-indigo-600">
            ...
            <p className="text-base leading-relaxed text-gray-600">
              Your location data is used to track attendance accurately and
              securely. We may also use your data for troubleshooting, analysis,
              and improving the app’s performance.
            </p>
          </div>
          ...
          <div className="group mb-10 p-6 bg-gray-100 rounded-lg shadow-sm transition-transform transform hover:-translate-y-2 hover:shadow-lg duration-300 ease-in-out border-l-4 border-indigo-600">
            ...
            <p className="text-base leading-relaxed text-gray-600">
              We use encryption and secure data storage to protect your
              information. Access to your data is restricted to authorized
              personnel only. While we strive to ensure the security of your
          ...
          <div className="group mb-10 p-6 bg-gray-100 rounded-lg shadow-sm transition-transform transform hover:-translate-y-2 hover:shadow-lg duration-300 ease-in-out border-l-4 border-indigo-600">
            ...
            <p className="text-base leading-relaxed text-gray-600">
              ...
              except as required by law or in the event of a business
              transaction.
            </p>
          </div>
          ...
          <div className="group mb-10 p-6 bg-gray-100 rounded-lg shadow-sm transition-transform transform hover:-translate-y-2 hover:shadow-lg duration-300 ease-in-out border-l-4 border-indigo-600">
            ...
            <p className="text-base leading-relaxed text-gray-600">
              You have the right to request access to the data we collect about
              you, as well as request corrections or deletion of your
              information. You can contact us at any time to exercise these
              rights.
            </p>
          </div>
