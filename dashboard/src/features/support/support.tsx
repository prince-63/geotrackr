      ...
      <section className="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 py-16 px-6 sm:px-12 lg:px-24 transition-colors duration-300">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-lg sm:text-xl leading-relaxed text-center mb-12 text-gray-700 dark:text-gray-300">
            We’re here to help! Find answers to frequently asked questions or
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-2">
            <div className="p-8 bg-white dark:bg-gray-800 rounded-lg shadow-md transition-transform transform hover:-translate-y-2 hover:shadow-2xl duration-300 ease-in-out">
              ...
              <p className="text-base text-gray-600 dark:text-gray-300 mb-4">
                Need further assistance? Get in touch with our support team for
            ...
            <div className="p-8 bg-white dark:bg-gray-800 rounded-lg shadow-md transition-transform transform hover:-translate-y-2 hover:shadow-2xl duration-300 ease-in-out">
              ...
              <p className="text-base text-gray-600 dark:text-gray-300 mb-4">
                Our support team is available for live chat Monday through
                Friday from 9 AM to 6 PM.
              </p>
              <button className="inline-block bg-green-600 dark:bg-green-500 text-white py-2 px-4 rounded-lg hover:bg-green-700 dark:hover:bg-green-600 transition-colors duration-300">
                Start Live Chat
              </button>
            </div>
          </div>
