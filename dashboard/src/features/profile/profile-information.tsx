...
import { updateOffice } from '../../api-services/profile-service';
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6 sm:p-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
          <Typography
            variant="h2"
            className="text-2xl md:text-3xl font-semibold text-gray-800 border-b-2 border-gray-300 pb-2"
          >
        ...
        <div className="space-y-6">
          <div className="bg-gray-100 p-4 rounded-lg shadow-inner">
            <h2 className="text-lg font-medium text-gray-700 border-b-2 border-gray-300 pb-2">
              Contact Information
            </h2>
            ...
            <p className="text-gray-600 mt-2 text-base">
              ...
              {officeContactNumber || '+123 456 7890'}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-100 p-4 rounded-lg shadow-inner">
              ...
              <p className="text-gray-600 mt-2 text-base">
                Pincode: {officePincodes || '000000'}
              </p>
              <p className="text-gray-600 text-base">
                Coordinates: {officeLongitude || 'Longitude'},{' '}
          ...
          {[
            {
              label: 'Office Name',
              value: officeName,
              setter: setOfficeName,
              type: 'text',
            },
            {
              label: 'Office Subtitle',
              value: officeSubTitle,
              setter: setOfficeSubTitle,
              type: 'text',
            },
            {
              label: 'Office Email',
              value: officeEmail,
              setter: setOfficeEmail,
              type: 'email',
            },
            {
              label: 'Contact Number',
              value: officeContactNumber,
              setter: setOfficeContactNumber,
              type: 'text',
            },
            {
              label: 'City',
              value: officeCity,
              setter: setOfficeCity,
              type: 'text',
            },
            {
              label: 'State',
              value: officeState,
              setter: setOfficeState,
              type: 'text',
            },
            {
              label: 'Country',
              value: officeCountry,
              setter: setOfficeCountry,
              type: 'text',
            },
            {
              label: 'Pincodes',
              value: officePincodes,
              setter: setOfficePincodes,
              type: 'text',
            },
            {
              label: 'Longitude',
              value: officeLongitude,
              setter: setOfficeLongitude,
              type: 'text',
            },
            {
              label: 'Latitude',
              value: officeLatitude,
              setter: setOfficeLatitude,
              type: 'text',
            },
